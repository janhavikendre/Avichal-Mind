    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 pt-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <Card className="bg-blue-600 text-white border-blue-600 shadow-sm">
            <CardHeader className="pb-2">
              <CardTitle className="text-xs sm:text-sm font-medium text-blue-100">Achievement Center</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          {loading ? (
            ...
            <div className="grid gap-4">
              {sessions.slice(0, 5).map((session) => (
                <Card key={session._id} className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                          ...
                          {session.safetyFlags.crisis && (
                            <Badge className="bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 border-red-200 dark:border-red-700">Crisis Flagged</Badge>
                          )}
                        </div>
                      ...
                      <div className="flex gap-2">
                        <Link href={`/session/${session._id}`}>
                          <Button className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 text-sm font-medium rounded-lg">
                            View
                          </Button>
                        </Link>
                        {!session.completedAt && (
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Link href="/session/new?mode=text">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white w-full py-3 text-base font-medium rounded-lg">
                  Start Text Session
                </Button>
              </Link>
              <Link href="/session/new?mode=voice">
                <Button className="bg-green-600 hover:bg-green-700 text-white w-full py-3 text-base font-medium rounded-lg">
                  Start Voice Session
                </Button>
              </Link>
            </div>
