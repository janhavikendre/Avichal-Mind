...
const features: Feature[] = [
  {
    ...
    title: "Psychiatrist",
    description: "Expert diagnosis and medication management for mental health conditions",
  ...
  },
  {
    ...
    description: "Therapy and counseling for anxiety, depression, and behavioral issues",
    gradient: "from-blue-600 to-blue-600",
  },
  {
    icon: (
  ...
  },
  {
    ...
    description: "Treatment and recovery support for substance abuse and addiction",
    gradient: "from-blue-600 to-blue-600",
  },
  {
    icon: (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto px-4">
            Find experienced mental health professionals across all specialties for comprehensive care
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, index) => {
            const specialties = {
              ...
              "Clinical Psychologist": "PhD/Masters",
              "Counseling Psychologist": "Masters Degree",
              "Child Psychologist": "Child Specialist",
              "Addiction Specialist": "Certified Specialist",
              "Trauma Specialist": "Specialized Training"
            };
            
            const badgeColors = {
              "Medical Degree": "bg-blue-100 text-blue-600",
              "PhD/Masters": "bg-green-100 text-green-600",
              "Masters Degree": "bg-purple-100 text-purple-600",
              "Child Specialist": "bg-pink-100 text-pink-600",
              "Certified Specialist": "bg-orange-100 text-orange-600",
              "Specialized Training": "bg-indigo-100 text-indigo-600"
            };
            ...
            return (
              ...
              >
                <div className="relative bg-white dark:bg-gray-900 rounded-lg p-8 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-1 overflow-hidden">
                  ...
                  <div className="w-16 h-16 bg-blue-50 dark:bg-blue-900/20 rounded-full flex items-center justify-center mb-6 mx-auto relative z-10">
                    {feature.icon}
                  </div>
                  ...
                  <div className="text-center">
                    <span className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${badgeColors[specialties[feature.title as keyof typeof specialties] as keyof typeof badgeColors]}`}>
                      {specialties[feature.title as keyof typeof specialties]}
                    </span>
                  </div>
                </div>
              </div>
