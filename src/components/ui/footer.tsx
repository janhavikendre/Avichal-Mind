        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="sm:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-lg sm:text-xl font-bold">Avichal Mind</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/session/new" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">
                  Start Session
                </Link>
              </li>
              <li>
                <Link href="/sessions" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">
                  Session History
                </Link>
              </li>
              <li>
                <Link href="/gamification" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">
                  Progress Tracking
                </Link>
              </li>
            </ul>
          ...
          {/* Support & Resources */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Support & Resources</h3>
            <ul className="space-y-2">
              <li>
